...
export const RENT_VS_BUY_FIELDS: RentVsBuyField[] = [
  ...
  { campo: "viviendaHabitual", etiqueta: "Es tu vivienda habitual", unidad: "boolean", min: 0, max: 1, avanzado: true, grupo: "compra", nota: "Vivienda de residencia habitual a efectos fiscales. Marcarla no elimina el IRPF: la exención requiere un supuesto separado y cumplir sus condiciones." },
