...
/** Identidad del artefacto recibido en nuevo_modelo el 16 de septiembre de 2026. */
export const CURRENT_MODEL_ID = "habitIA-xgboost-2018-v3";
export const CURRENT_MODEL_VERSION = "3.2.0";
export const CURRENT_MODEL_SHA256 = "e5526aca6001741f24eb976dbd9607df131b3822b5b5a01b66c6c92af2a9d748";
export const CURRENT_SALE_YEAR = 2025;
export const CURRENT_RENT_YEAR = 2024;
...
export function isCurrentModel(value: { model_id?: unknown; model_version?: unknown; modelo_sha256?: unknown } | null | undefined): boolean {
  return value?.model_id === CURRENT_MODEL_ID && value.model_version === CURRENT_MODEL_VERSION
    && value.modelo_sha256 === CURRENT_MODEL_SHA256;
}
...
export function isCurrentValuation(value: PropertyValuation | null | undefined): value is PropertyValuation & { modeloVersion: string; modeloId: typeof CURRENT_MODEL_ID; modeloSha256: string } {
  return !!value && isCurrentModel({ model_id: value.modeloId, model_version: value.modeloVersion, modelo_sha256: value.modeloSha256 });
}
