...
import diagram from "@/public/presentacion/arquitectura-hosting-v1.png";
...
export function ArchitectureGraphic({ presentation = false }: { presentation?: boolean }) {
  return <figure className={presentation ? styles.slide : styles.figure}>
    <a href="/presentacion/arquitectura-hosting-v1.png" target="_blank" rel="noopener noreferrer" className={styles.link} aria-label="Abrir infografía de arquitectura en tamaño completo">
