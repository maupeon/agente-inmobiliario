...
La evaluación con anuncios recientes, idealmente con precios de cierre, permitiría medir la precisión actual por distrito, tipología y calidad de la información, y entrenar un modelo específico de alquiler. Se propone sustituir los índices proyectados por datos registrales observados, calibrar intervalos de predicción mediante regresión cuantílica o predicción conformal para cuantificar la incertidumbre, y validar con particiones espaciales o temporales el efecto de los indicadores de barrio.

También se revisará el HabitIA Score: las escalas provisionales de Fair, Opportunity y Lifestyle se sustituirán, cuando corresponda, por percentiles de distribuciones de referencia para cada métrica, respetando su sentido, comparando ámbitos homogéneos y revisando qué mide Opportunity. Zone ya usa percentiles, pero deberá normalizar sus indicadores por población o superficie y estudiar una escala territorial más próxima a la vivienda. Las referencias se estimarán con datos de calibración y se actualizarán con nuevas observaciones; su estabilidad y capacidad de ordenación se comprobarán en una muestra independiente. Si se utiliza el test actual para ajustarlas, dejará de constituir una evaluación independiente.
