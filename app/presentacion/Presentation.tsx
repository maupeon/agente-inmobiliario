...
const SCENES: SceneDefinition[] = [
  ...
  },
  {
    ...
    "target": 360,
    "note": "Modelo de valoración: arboles_desplegable_ajustado, XGBoost, paquete v3 exportado el 15 de septiembre de 2026. 21 variables, 410 árboles, profundidad máxima 12. La predicción base es exp(predicción logarítmica) por 1,0167794824519134, corrección de Duan. Estima precios anunciados de 2018; no precios de cierre ni un valor verdadero. MdAPE 9,2990% y MAE 49.220,20 euros declarados en su test de 2018. No comparar directamente estas cifras con las del experimento anterior: faltan particiones y tamaño del test. El titular expresa el objetivo del producto; el resultado sigue siendo una estimación. La diapositiva muestra la actualización prevista a 2026, con índices pendientes de incorporar. El paquete usa un factor de venta distrital, que no debe confundirse con el IPV autonómico. Actualizar a 2026 exige documentar fuentes compatibles y volver a validar; cambiar las fechas de la fórmula no actualiza el modelo. El paquete implementado funciona así: venta: multiplica la estimación base por indice_venta del distrito hasta 2025; no aplicar el factor heredado 1,5534 ni el IPV autonómico de 2026. Alquiler: multiplica el precio indexado por factor_renta_mensual del distrito de 2024; el factor ya es mensual y no se divide de nuevo entre 12. Esa mensualidad es un escenario derivado sin validación independiente de alquiler. No hay intervalos ni SHAP exportados, y el ajuste de nivel no demuestra precisión actual."
  },
  {
