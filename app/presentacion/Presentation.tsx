...
const SCENES: SceneDefinition[] = [
  ...
  },
  {
    ...
    "target": 561,
    "note": "La web y el backend Next.js están planteados en Vercel; el servicio Python/FastAPI en Fly.io; PostgreSQL y automatizaciones en Supabase; Claude mediante Anthropic. Panel y chat usan herramientas compartidas. El contrato XGBoost v3 está incorporado en la web y en el servicio: carga el predictor una vez, prepara 21 variables y devuelve precio base de 2018, precio de venta a nivel de 2025, renta derivada con ratios de 2024 y advertencias por anuncio. No entrena durante la búsqueda, no exporta intervalos ni SHAP. La aplicación deriva Fair de sus importes mediante una escala provisional. El adaptador 3.1 admite venta y alquiler; el paquete original del predictor admite anuncios de venta. Claude interpreta y explica los resultados. La incorporación en código no sustituye a comprobar la conexión del despliegue. Historial y favoritos de la demo son compartidos; el perfil vive en el navegador y las notificaciones se identifican con su cookie."
  },
  {
