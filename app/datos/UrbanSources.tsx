...
export function UrbanSources() {
  ...
  return (
    <div className="mt-8 space-y-8" id="fuentes-entorno">
      ...
      <p className="text-sm leading-relaxed text-stone-600">Estas fuentes aportan contexto para tu decisión. No se convierten en puntuaciones del barrio ni modifican el Zone Score. Las tablas son copias fechadas; consulta la fuente para comprobar cambios posteriores.</p>
    </div>
  );
}
