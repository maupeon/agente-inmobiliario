...
const SOURCES: Array<{ fuente: string; aporta: string; estado: Estado; refresco: string; href?: string }> = [
  ...
  { fuente: "Modelo XGBoost · alquiler", aporta: `Renta mensual derivada de la venta estimada y ratios distritales. Actualización a ${INDEX_TARGET_YEAR} pendiente; sin validación independiente de alquiler`, estado: "proveedor", refresco: "Al consultar una vivienda, si el modelo está disponible" },
