...
- El predictor XGBoost v3 utiliza 21 variables y un índice de venta por distrito a 2025. No incluye intervalos calibrados ni bandas. Fair usa la desviación frente a la estimación individual en una escala provisional de 0–100. Admite anuncios de compra y alquiler (contrato 3.1.0): compara el precio total de venta o la mensualidad en €/mes. Su renta deriva del valor de venta estimado y ratios de 2024, sin validación independiente de alquiler. Los resultados LightGBM de la presentación siguen identificados como evaluación histórica de otro modelo.
...
- El HabitIA Score combina Fair, Opportunity, Zone y Lifestyle. Los componentes sin evidencia no aportan puntos y sus pesos no se redistribuyen. Opportunity compara, solo en compra, la variación anual de oferta del distrito con Madrid (Idealista, agosto 2025–agosto 2026). Zone aplica la fórmula de cinco percentiles a recuentos de distrito: hay cuatro indicadores disponibles y falta ruido. Se muestra como parcial y su cobertura interna del 80% se incorpora a la cobertura global.
